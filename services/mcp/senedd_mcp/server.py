...
Run locally (stdio):      uv run python -m senedd_mcp
Run as an HTTP service:   uv run python -m senedd_mcp --transport streamable-http
"""
import argparse
import logging
...
from senedd_search import lookups
from senedd_search.service import semantic_search
